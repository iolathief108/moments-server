...
export async function InitDatabase() {
    ...
    try {
        let data = fs.readFileSync("./src/sample_data/static/provinces.json", "utf8");
    ...
    try {
        let data = fs.readFileSync("./src/sample_data/static/district.json", "utf8");
        // console.log(data)
    ...
    try {
        let data = fs.readFileSync("./src/sample_data/static/cities.json", "utf8");
