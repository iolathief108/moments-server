...
import { IMAGE_PATH } from '../common/const';
...
function getImageDirectory(dirNames: DirNames) {

    let basePath = process.env.GEN_DATA_PATH;
    
    if (!basePath) throw new Error("GEN_DATA_PATH is undefined!")
